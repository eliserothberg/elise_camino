...
class CustomUserManager(BaseUserManager):
    def _create_user(self, phone, name, class_name, 
                    pin, 
        ...
        phone = self.normalize_name(phone)
...
class LoginCode(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, related_name='code_to_login',
...
#     """
    ...
    def phone_user(self, message, TWILIO_NUMBER=None):
            
        send_phone(message, TWILIO_NUMBER, [self.phone])